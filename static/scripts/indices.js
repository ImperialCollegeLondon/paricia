        ...
        $.ajax({
            ...
            $("#div_informacion").attr('hidden', false);
                ...
                if(data != null){
                    ...
                    rows += '<tr>';
                    if(screen.width <= 720 ){
                        rows +=    '<td >Precipitación media  <br> anual (mm).</td>';
                    }
                    else{
                        rows +=    '<td >Precipitación media anual (mm).</td>';
                    }

                    rows +=    '<td >'+data.prom_anual+'</td>';
                    rows +=    '<td style="display:none;"></td>';
                    rows += '</tr><tr>';
                    rows +=    '<td >Año más seco (mm).</td>';
                    rows +=    '<td >'+data.secHum.anio_seco+'</td>';
                    rows +=    '<td >'+data.secHum.fechsec+'</td>';
                    rows += '</tr><tr>';
                    rows +=    '<td >Año más lluvioso (mm).</td>';
                    rows +=    '<td >'+data.secHum.anio_humedo+'</td>';
                    rows +=    '<td >'+data.secHum.fechhum+'</td>';
                    rows += '</tr><tr >';
                    if(screen.width <= 720 ){
                        rows += '<td >Intensidad máxima de <br> precipitación  acumulado <br>en una hora (mm/hora).</td>';
                    }
                    else{
                        rows += '<td >Intensidad máxima de precipitación  acumulado en una hora (mm/hora).</td>';
                    }

                    rows +=    '<td >'+ data.max_hora.valor_max.toFixed(2); +'</td>';
                    rows +=    '<td ><small>Desde: </small> '+data.max_hora.fecha_ini+'<br><small>Hasta: </small>'+data.max_hora.fecha_fin+'</td>';
                    rows += '</tr>';
                    rows += '<tr>';
                    rows +=    '<td >Percentiles con datos horarios (mm/hora).</td>';
                    rows +=    '<td colspan="2">';
                    rows +=       '<table>';
                    rows +=          '<tr><th>Percentil 10</th><th>Percentil 95</th></tr>';
                    rows +=          '<tr><td>'+data.percentiles_horarios.q10.__Decimal__+'</td><td>'+data.percentiles_horarios.q95.__Decimal__+'</td></tr>';
                    rows +=       '</table>';
                    rows +=    '</td>';
                    rows += '</tr>';
                    rows += '<tr>';
                    rows +=    '<td >Percentiles con datos diarios (mm/día).</td>';
                    rows +=    '<td colspan="2">';
                    rows +=       '<table>';
                    rows +=          '<tr><th>Percentil 10</th><th>Percentil 95</th></tr>';
                    rows +=          '<tr><td>'+data.percentiles_diarios.q10.__Decimal__+'</td><td>'+data.percentiles_diarios.q95.__Decimal__+'</td></tr>';
                    rows +=       '</table>';
                    rows +=    '</td>';
                    rows += '</tr>';
                    rows += '<tr>';
                    rows +=    '<td >Número de días sin precipitación</td>';
                    rows +=    '<td colspan="2">';
                    rows +=          data.dias_sin_precipitacion;
                    rows +=    '</td>';
                    rows += '</tr>';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data != null){
                    ...
                    rows += '<tr>';
                    if(screen.width <= 720 ){
                        rows += '<td class="col-sm-4" style="width: 50%">Caudal mínimo<br/>diario (L/s).';
                    }
                    else{
                        rows += '<td class="col-sm-4" style="width: 50%">Caudal mínimo diario (L/s).';
                    }
                    rows += '<td class="col-sm-2" style="width: 20%">'+data.cmim +'</td>';
                    rows += '<td class="col-sm-2" style="width: 20%">'+data.fdmin+'</td>'; 
                    rows += '</tr> <tr>';
                    rows += '<td class="col-sm-4" style="width: 50%">Q 95  (L/s).</td>';
                    rows += '<td class="col-sm-2" style="width: 20%">'+data.per10+'</td>';
                    rows += '<td class="col-sm-2"  style="display:none;"></td>';
                    rows += '</tr> <tr>';
                    if(screen.width <= 720 ){
                        rows += '<td col-sm-4" style="width: 60%" >Promedio de caudal<br/>del mes más seco <br>(L/s).</td>';
                    }
                    else{
                        rows += '<td col-sm-4" style="width: 60%" >Promedio de caudal del mes más seco (L/s).</td>';
                    }
                    rows += '<td class="col-sm-2" style="width: 20%" >'+data.cmessec+'</td><td class="col-sm-2" style="width: 20%">'+ data.fecmessec+'</td>'; //fecmessec
                    rows += '</tr>';
                    rows += '<tr>';
                    rows += '<td col-sm-4" style="width: 50%">Número de días sin caudal</td>';
                        rows += '<td>'+data.dias_sin_caudal+'</td>';
                        rows += '<td style="display:none;"></td>';
                    rows += '</tr>';
                    rows += '<tr> <th col-sm-4" style="width: 50%">Caudales altos</th>';
                    rows += '<td class="col-sm-2"  style="display:none;"></td>';
                    rows += '<td class="col-sm-2"  style="display:none;"></td>';
                    rows += '</tr> <tr>';
                    if(screen.width <= 720 ){
                        rows += '<td col-sm-4" style="width: 60%" >Caudal máximo diario<br/>(L/s).</td>';
                    }
                    else{
                        rows += '<td col-sm-4" style="width: 60%" >Caudal máximo diario (L/s).</td>';
                    }
                    rows += '<td class="col-sm-2" style="width: 20%">'+data.cmax+'</td>';
                    rows += '<td class="col-sm-2" style="width: 20%">'+data.fdmax+'</td>';
                    rows += '</tr> <tr>';
                    rows += '<td col-sm-4" style="width: 60%" >Q 10 (L/s).</td>';
                    ...
                    rows += '</tr> <tr>';
                    if(screen.width <= 720 ){
                        rows += '<td class="col-sm-4" style="width: 20%" >Caudal <br>promedio diario anual<br>o mensual (L/s).</td>';

                    }
                    else{
                        rows += '<td col-sm-4" style="width: 60%" >Caudal promedio diario (L/s).</td>';

                    }
                    rows += '<td class="col-sm-2" style="width: 20%">'+data.cavg +'</td>';
                    rows += '<td class="col-sm-2"  style="display:none;"></td>';
                    rows += '</tr> <tr>';
                    rows += '<td col-sm-4" style="width: 50%">Q50 (L/s).</td>';
                    rows += '<td class="col-sm-2" style="width: 20%">'+data.per50 +'</td>';
                    rows += '<td class="col-sm-2"  style="display:none;"></td>';
                    rows += '</tr>';
                    $("#tbody").html(rows);

                    /// Tabla de valores mensuales de caudal
                    $("#mensuales_caudal").html(data.tabla_caudal);
                    ...
                    if (data.inf === "vacio"){
                        ...
                        rows += '<tr>';
                        if(screen.width <= 720 ){
                            rows += '<td col-sm-4" style="width: 60%" >Caudal mínimo diario<br/> (L/s/km<sup>2</sup>)</td>';
                        }
                        else{
                            rows += '<td col-sm-4" style="width: 60%" >Caudal mínimo diario<br/> (L/s/km<sup>2</sup>)</td>';
                        ...
                        rows += '</tr> <tr>';
                        rows += '<td col-sm-4" style="width: 60%" >Q 95.  (L/s/km<sup>2</sup>).</td>';
                        rows += '<td class="col-sm-2" style="width: 20%">'+data.per10_es +'</td>';
                        rows += '<td class="col-sm-2"  style="display:none;"></td>';
                        rows += '</tr> <tr>';
                        if(screen.width <= 720 ){
                            rows += '<td col-sm-4" style="width: 60%" >Promedio de caudal del <br/>mes más seco (L/s/km<sup>2</sup>).</td>';
                        }
                        else{
                            rows += '<td col-sm-4" style="width: 60%" >Promedio de caudal del mes más seco (L/s/km<sup>2</sup>).</td>';
                        ...
                        rows += '</tr> <tr>';
                        if(screen.width <= 720 ){
                            rows += '<td col-sm-4" style="width: 60%" >Caudal máximo diario <br/>(L/s/km<sup>2</sup>).</td>';
                        }
                        else{
                            rows += '<td col-sm-4" style="width: 60%" >Caudal máximo diario(L/s/km<sup>2</sup>).</td>';
    
                        }
                        rows += '<td class="col-sm-2" style="width: 20%">'+data.cmax_es +'</td>';
                        rows += '<td class="col-sm-2" style="width: 20%">'+data.fdmax_es+'</td>';
                        rows += '</tr> <tr>';
                        rows += '<td col-sm-4" style="width: 60%" >Q 10 (L/s/km<sup>2</sup>).</td>';
                        ...
                        rows += '</tr> <tr>';
                        if(screen.width <= 720 ){
                            rows += '<td col-sm-4" style="width: 60%" >Caudal promedio<br>diario<br> (L/s/km<sup>2</sup>).</td>';
                        }
                        else{
                            rows += '<td col-sm-4" style="width: 60%" >Caudal promedio diario. (L/s/km<sup>2</sup>).</td>';
                        ...
                        rows += '<td class="col-sm-2"  style="display:none;"></td>';
                        rows += '</tr> <tr>';
                        rows += '<td col-sm-4" style="width: 60%" >Q50 (L/s/km<sup>2</sup>).</td>';
...
// intencidad multiestacion cau_multi
    ...
    function gIntensidad(divref,data){
        ...
        Plotly.newPlot(divref, data, layout, config);
    };
    ...
    function duracaudal(id_div,data, mtit,xtit,ytit){
        ...
        Plotly.newPlot(id_div, data, layout, config);
    }
