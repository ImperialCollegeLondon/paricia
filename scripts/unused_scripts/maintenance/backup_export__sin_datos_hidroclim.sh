...
py_manage dumpdata --indent 2 bitacora.bitacora > bitacora_bitacora.json
py_manage dumpdata --indent 2 cruce.cruce > cruce_cruce.json
py_manage dumpdata --indent 2 datalogger.datalogger > datalogger_datalogger.json
py_manage dumpdata --indent 2 datalogger.marca > datalogger_marca.json
...
py_manage dumpdata --indent 2 formato.asociacion > formato_asociacion.json
py_manage dumpdata --indent 2 formato.clasificacion > formato_clasificacion.json
py_manage dumpdata --indent 2 formato.delimitador > formato_delimitador.json
py_manage dumpdata --indent 2 formato.extension > formato_extension.json
py_manage dumpdata --indent 2 formato.fecha > formato_fecha.json
py_manage dumpdata --indent 2 formato.formato > formato_formato.json
py_manage dumpdata --indent 2 formato.hora > formato_hora.json
py_manage dumpdata --indent 2 frecuencia.frecuencia > frecuencia_frecuencia.json
py_manage dumpdata --indent 2 frecuencia.tipofrecuencia > frecuencia_tipofrecuencia.json
py_manage dumpdata --indent 2 frecuencia.usuariotipofrecuencia > frecuencia_usuariotipofrecuencia.json
py_manage dumpdata --indent 2 importacion.importacion > importacion_importacion.json
py_manage dumpdata --indent 2 importacion.importaciontemp > importacion_importaciontemp.json
py_manage dumpdata --indent 2 instalacion.instalacion > instalacion_instalacion.json
py_manage dumpdata --indent 2 medicion.caudalviaestacion > medicion_caudalviaestacion.json
py_manage dumpdata --indent 2 medicion.curvadescarga > medicion_curvadescarga.json
py_manage dumpdata --indent 2 medicion.nivelfuncion > medicion_nivelfuncion.json
py_manage dumpdata --indent 2 sensor.marca > sensor_marca.json
py_manage dumpdata --indent 2 sensor.sensor > sensor_sensor.json
py_manage dumpdata --indent 2 sensor.tipo > sensor_tipo.json
py_manage dumpdata --indent 2 telemetria.alarmaemail > telemetria_alarmaemail.json
py_manage dumpdata --indent 2 telemetria.alarmaestado > telemetria_alarmaestado.json
py_manage dumpdata --indent 2 telemetria.alarmatipoestado > telemetria_alarmatipoestado.json
py_manage dumpdata --indent 2 telemetria.configcalidad > telemetria_configcalidad.json
py_manage dumpdata --indent 2 telemetria.configvisualizar > telemetria_configvisualizar.json
py_manage dumpdata --indent 2 telemetria.televariables > telemetria_televariables.json
py_manage dumpdata --indent 2 validacion.agua > validacion_agua.json
py_manage dumpdata --indent 2 validacion.comentariovalidacion > validacion_comentariovalidacion.json
py_manage dumpdata --indent 2 validacion_v2.consulta > validacion_v2_consulta.json
py_manage dumpdata --indent 2 validacion.validacion > validacion_validacion.json
py_manage dumpdata --indent 2 variable.control > variable_control.json
py_manage dumpdata --indent 2 variable.curvadescarga > variable_curvadescarga.json
py_manage dumpdata --indent 2 variable.unidad > variable_unidad.json
py_manage dumpdata --indent 2 variable.variable > variable_variable.json
