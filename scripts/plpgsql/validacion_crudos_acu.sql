DROP FUNCTION IF EXISTS  public.reporte_validacion_precipitacion(integer, timestamp with time zone, timestamp with time zone, numeric, numeric);
--DROP FUNCTION public.reporte_validacion_precipitacion(integer, timestamp with time zone, timestamp with time zone);
...
CREATE OR REPLACE FUNCTION public.reporte_validacion_precipitacion(
	...
	_var_maximo numeric,
	_var_minimo numeric)
    RETURNS TABLE(id bigint, fecha timestamp with time zone, valor numeric, validado boolean,
    seleccionado boolean,
    estado boolean, fecha_error numeric, valor_error boolean, stddev_error boolean, comentario character varying
