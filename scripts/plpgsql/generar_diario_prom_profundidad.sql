DROP FUNCTION IF EXISTS generar_diario_var101();
CREATE OR REPLACE FUNCTION generar_diario_var101()
  RETURNS boolean AS
$BODY$
...
BEGIN
    ...
    update_diario AS (
        UPDATE diario_var101diario SET
    ...
    update_USADO_PARA_DIARIO AS (
        UPDATE horario_var101horario SET usado_para_diario = TRUE
