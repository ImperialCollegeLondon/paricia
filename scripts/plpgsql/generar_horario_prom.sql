...
BEGIN
    ...
    validados AS(
        SELECT id, estacion_id, fecha, valor, validacion FROM validacion_var2validado v
    ...
    insert_horario AS (
        INSERT INTO horario_var2horario(estacion_id, fecha, valor, max_abs, min_abs, completo_mediciones, usado_para_diario)
