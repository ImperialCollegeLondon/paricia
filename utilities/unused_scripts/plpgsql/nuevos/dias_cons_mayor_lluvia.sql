-- FUNCTION: public.dias_cons_mayor_lluvia(integer, date, date, numeric)

-- DROP FUNCTION public.dias_cons_mayor_lluvia(integer, date, date, numeric);

CREATE OR REPLACE FUNCTION public.dias_cons_mayor_lluvia(
	estacionid integer,
	fecha1 date,
	fecha2 date,
	valorc numeric)
...
BEGIN
	...
	raise notice 'existen % meses', mes_ver; 
	if mes_ver < 11 then
		return null;
	else
...
-- ALTER FUNCTION public.dias_cons_mayor_lluvia(integer, date, date, numeric)
--    OWNER TO usuario1;
