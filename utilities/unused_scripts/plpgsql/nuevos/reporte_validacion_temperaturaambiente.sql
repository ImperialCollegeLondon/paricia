-- FUNCTION: public.reporte_validacion_temperaturaambiente(integer, timestamp with time zone, timestamp with time zone, numeric, numeric)

-- DROP FUNCTION public.reporte_validacion_temperaturaambiente(integer, timestamp with time zone, timestamp with time zone, numeric, numeric);

CREATE OR REPLACE FUNCTION public.reporte_validacion_temperaturaambiente(
...
--ALTER FUNCTION public.reporte_validacion_temperaturaambiente(integer, timestamp with time zone, timestamp with time zone, numeric, numeric)
--    OWNER TO usuario1;
