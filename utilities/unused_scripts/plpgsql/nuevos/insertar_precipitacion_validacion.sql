...
-- DROP FUNCTION public.insertar_precipitacion_validacion(bigint, json);
...
BEGIN
    FOR row_datos in curs_datos LOOP
        ...
        IF row_datos.seleccionado is TRUE THEN
            INSERT INTO validacion_var1validado(estacion_id, fecha, valor, usado_para_horario, validacion)
                VALUES (_estacion_id, row_datos.fecha, valor, FALSE, 0)
