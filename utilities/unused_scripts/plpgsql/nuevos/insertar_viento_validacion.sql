-- FUNCTION: public.insertar_viento_validacion(bigint, json)
...
BEGIN
    FOR row_datos in curs_datos LOOP
        ...
        IF row_datos.seleccionado is TRUE THEN
			...
			VALUES (_estacion_id, row_datos.fecha, row_datos.direccion, FALSE, 0, maximo, minimo);

            INSERT INTO validacion_var4validado(estacion_id, fecha, valor, usado_para_horario, validacion, maximo, minimo)
			VALUES (_estacion_id, row_datos.fecha, row_datos.valor, FALSE, 0, maximo, minimo);
