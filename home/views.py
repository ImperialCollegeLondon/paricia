...
from .forms import CargaInicialForm, OPCIONES_CARGA
    ...
    def form_valid(self, form):
        ...
        for e in OPCIONES_CARGA:
            if e[0] == tabla:
                tabla_descrip = e[1]
        try:
            execute_from_command_line(['manage.py', "loaddata", settings.BASE_DIR + "/home/data/" + tabla])
        except:
            mensaje_err = 'Ha ocurrido un error en la carga ' + tabla_descrip
            return self.render_to_response(self.get_context_data(mensaje_err=mensaje_err))
