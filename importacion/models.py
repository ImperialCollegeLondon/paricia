...
class ImportacionBase(models.Model):
    ...
    imp_observacion = models.TextField("Observaciones/Anotaciones", blank=True, null=True)
    usuario = models.ForeignKey(User, models.SET_NULL, blank=True, null=True, verbose_name="Usuario")
...
class Importacion(ImportacionBase):
    ...
    class Meta:
        ordering = ('-imp_fecha',)
        permissions = [
            ("descarga_archivo_original", "Descargar el archivo original que fue cargado al sistema."),
        ]
