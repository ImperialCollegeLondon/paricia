...
urlpatterns = [
    ...
    re_path(r'^reportes/mensual_multianual/$', views.MensualMultianual.as_view(), name='mensual_multianual'),
    re_path(r'^reportes/comparacion/$', views.ComparacionReporte.as_view(), name='comparacion_reporte'),
    re_path(r'^reportes/comparacion_variables/$', views.ComparacionVariables.as_view(), name='comparacion_variables'),
    ...
    re_path(r'^reportes/calidad/consultas/$', views.CalidadConsultasPeriodo.as_view(), name='calidad_consultas_periodo'),
