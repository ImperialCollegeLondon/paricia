...
# Cruce views
class CruceCreate(LoginRequiredMixin, AjaxableResponseMixin, CreateView):
    model = Cruce
...
class CruceUpdate(LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        print(self.object.cru_id)
        context['url'] = "/cruce/edit/" + str(self.object.cru_id)+"/"
        return context
