...
urlpatterns = [
    ...
    re_path(r'^formato/fecha/create/$', views.FechaCreate.as_view(), name='fecha_create'),
    re_path(r'^formato/fecha/detail/(?P<pk>[0-9]+)/$', views.FechaDetail.as_view(), name='fecha_detail'),
    re_path(r'^formato/fecha/(?P<pk>[0-9]+)/$', views.FechaUpdate.as_view(), name='fecha_update'),
    re_path(r'^formato/fecha/(?P<pk>[0-9]+)/delete/$', views.FechaDelete.as_view(), name='fecha_delete'),
    ...
    re_path(r'^formato/hors/detail/(?P<pk>[0-9]+)/$', views.HoraDetail.as_view(), name='hora_detail'),
    re_path(r'^formato/hora/(?P<pk>[0-9]+)/$', views.HoraUpdate.as_view(), name='hora_update'),
    re_path(r'^formato/hora/(?P<pk>[0-9]+)/delete/$', views.HoraDelete.as_view(), name='hora_delete'),
