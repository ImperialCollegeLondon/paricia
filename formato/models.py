...
class Formato(models.Model):
    ...
    ext_id = models.ForeignKey(Extension, on_delete=models.SET_NULL, blank=True, null=True, verbose_name="Extensión del Archivo")
    del_id = models.ForeignKey(Delimitador, on_delete=models.SET_NULL, blank=True, null=True, verbose_name="Delimitador")
    ...
    fec_id = models.ForeignKey(Fecha, on_delete=models.SET_NULL, blank=True, null=True, verbose_name="Formato de Fecha")
    ...
    hor_id = models.ForeignKey(Hora, on_delete=models.SET_NULL, blank=True, null=True, verbose_name="Formato de Hora")
    for_col_hora = models.SmallIntegerField("Columna de hora")
    for_tipo = models.CharField("Tipo de Formato", max_length=25, choices=(('automatico', 'automático'), ('convencional', 'convencional'),))
...
class Clasificacion(models.Model):
    ...
    for_id = models.ForeignKey(Formato, on_delete=models.CASCADE, verbose_name="Formato")
    var_id = models.ForeignKey(Variable, on_delete=models.CASCADE, verbose_name="Variable")
    ...
    resolucion = models.DecimalField("Resolución", max_digits=6, decimal_places=2, blank=True, null=True)
...
class Asociacion(models.Model):
    ...
    for_id = models.ForeignKey(Formato, models.SET_NULL, blank=True, null=True, verbose_name="Formato")
