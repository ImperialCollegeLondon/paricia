...
from estacion.models import Estacion, Sitio, Cuenca, SitioCuenca
...
from reportes_v2.consultas.forms import (ConsultasPeriodoForm, ComparacionForm, ComparacionFormPublico,
                                      VariableForm, VariableFormPublico,
...
from reportes_v2.functions import (filtrar, comparar, comparar_variables, procesar_json_inamhi,
                                consultar_datos_usuario, mapa_estaciones_variable)
from reportes_v2.excel import reporte_excel_anuario

from reportes_v2.sitiocuenca import (
    get_datos_graficar,
    export_csv,
    export_excel
)
