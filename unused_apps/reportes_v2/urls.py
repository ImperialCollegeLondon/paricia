...
urlpatterns = [
    re_path(
        r"^reportes_v2/anuario/$", views.reportes_v2Anuario.as_view(), name="anuario"
    ),
    re_path(
        r"^reportes_v2/consultas/$",
        views.ConsultasPeriodo.as_view(),
        name="consultas_periodo",
    ),
    re_path(
        r"^reportes_v2/comparacion/$",
        views.ComparacionValores.as_view(),
        name="comparacion_reporte",
    ),
    path(
        "reportes_v2/comparar/estaciones",
        views.CompararEstacionesPublico.as_view(),
        name="comparar_estaciones_publico",
    ),
    re_path(
        r"^reportes_v2/compararvariable/$",
        views.ComparacionVariables.as_view(),
        name="comparacion_variable",
    ),
    path(
        "reportes_v2/comparar/variable",
        views.ComparacionVariablesPublico.as_view(),
        name="comparacion_variable_publico",
    ),
    re_path(
        r"^reportes_v2/estacionvariable/$",
        views.ConsultasEstacionVariable.as_view(),
        name="estacion_variable",
    ),
    re_path(
    ...
    path(
        "reportes_v2/usuarios/",
        views.ConsultasUsuario.as_view(),
        name="consultas_usuario",
    ),
    ...
    path(
        "reportes_v2/mapa/variable/<int:var_id>",
        views.MapaCompararEstaciones.as_view(),
        name="mapa_estaciones_variable",
    ),
    path(
        "reportes_v2/mapa/variable/publico/<int:var_id>",
        views.MapaCompararEstacionesPublico.as_view(),
        name="mapa_estaciones_variable",
    ),
]
