...
urlpatterns = [
    ...
    path(
        "indices/intensidadmulti/",
        IntensidadRRMultiestacion.as_view(),
        name="intensidadmulti",
    ),
    ...
    path(
        "indices/duracaudalmulti/",
        DuracionCaudalMultiestacion.as_view(),
        name="duracaudalmulti",
    ),
    ...
    path(
        "indices/listar_fecha_caudal/<int:estacion>",
        listar_fecha_caudal,
        name="listar_fecha_caudal",
    ),
    path(
        "indices/listar_fecha_precipitacion/<int:estacion>",
        listar_fecha_precipitacion,
        name="listar_fecha_precipitacion",
    ),
    path("indices/escorrentia/", EscorrentiaView.as_view(), name="escorrentia"),
    path(
        "indices/estaciones_en_cuenca/<int:sitiocuenca_id>",
        estaciones_en_cuenca,
        name="estaciones_en_cuenca",
    ),
]
